...
import { Plus, Trash2, RotateCcw, ClipboardCheck } from "lucide-react"
    ...
    <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
      ...
      <div style={{
        ...
        <p style={{ fontSize: 12, color: "var(--foreground)", lineHeight: 1.5 }}>
          Los estados base (<strong>Exitoso</strong>, <strong>Fallido</strong>, <strong>Error preexistente</strong>, <strong>Bloqueado</strong>) no se pueden eliminar.
          Puedes cambiar su etiqueta, color y si son aceptados o no. Agrega estados personalizados según tus necesidades.
        </p>
      </div>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 6, marginBottom: 12 }}>
        ...
        {resultados.map(r => (
          <div key={r.id} style={{
            ...
            <Input
              value={r.label}
              onChange={e => cambiarLabel(r.id, e.target.value)}
            ...
            {/* maxRetesteos — solo para resultados no aceptados */}
            {!r.esAceptado && (
