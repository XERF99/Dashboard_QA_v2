...
import {
  ...
  getTipoPruebaLabel, type TipoPruebaDef,
} from "@/lib/types"
...
const COMPLEJIDAD_CFG: Record<ComplejidadCaso, { label: string; cls: string }> = {
  alta:  { label: "Alta",  cls: "bg-red-50 text-red-700 border-red-300 dark:bg-red-950/30 dark:text-red-400 dark:border-red-800" },
  media: { label: "Media", cls: "bg-amber-50 text-amber-700 border-amber-300 dark:bg-amber-950/30 dark:text-amber-400 dark:border-amber-800" },
  baja:  { label: "Baja",  cls: "bg-green-50 text-green-700 border-green-300 dark:bg-green-950/30 dark:text-green-400 dark:border-green-800" },
}
